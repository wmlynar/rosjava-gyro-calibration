package com.github.wmlynar.rosjava.n.kf;
...
public class KalmanFilter {
    ...
    public KalmanFilter(Model model) {
        ...
        model.initialProcessNoiseCovariance(model.process_noise_covariance.data);
    }
     ...
     */
    public void update(double t, Observation obs) {
        do {
            double dt = t - time;
    ...
    public void predict(double dt) {
        ...
        model.updateProcessNoiseCovariance(model.process_noise_covariance.data);
    ...
    void estimate(Observation obs) {
        ...
        obs.updateObservationNoiseCovariance(obs.observation_noise_covariance.data);
