...
public class SlientServerExampleWithoutCore {
    ...
    public static void main(String[] args) {
        ...
        // This is because I work on a remote machine masteruri has the roscore
        // machine
        ...
        Preconditions.checkState(SlientServerExampleWithoutCore.serverNode != null);
        // execute the nodelet talker (this will run the method onStart of
        // Talker.java)
        nodeMainExecutor.execute(SlientServerExampleWithoutCore.serverNode, serverNodeConfiguration);
        ...
        Preconditions.checkState(SlientServerExampleWithoutCore.clientNode != null);
        nodeMainExecutor.execute(SlientServerExampleWithoutCore.clientNode, clientNodeConfiguration);
