...
public class LoggingRosMessagesTest {
    ...
    public void test() {
        ...
        // messageFactory.newFromType(sensor_msgs.LaserScan._TYPE);
        // nav_msgs.Odometry odom =
        // messageFactory.newFromType(nav_msgs.Odometry._TYPE);
        // geometry_msgs.Vector3Stamped distances =
        // messageFactory.newFromType(geometry_msgs.Vector3Stamped._TYPE);
